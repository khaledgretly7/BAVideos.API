...
namespace BAVideoSearch.Services
{
    public class VideoService
    {
        ...
        public VideoService(ISolrOperations<Video> solr)
        {
            _solr = solr;
        }
        ...
        public async Task<SearchResultModel> SearchVideos(string title = null, string description = null, string Category = null, string UploaderId = null, DateTime? uploadDate = null, int startIndex = 0, int rows = 10)
        {
                ...
                ExtraParams = new Dictionary<string, string>
    {
        ...
        { "fl", "video_id,video_title,video_description" } // Ensure fields are returned in the response
            ...
            var searchResultModel = new SearchResultModel
            {
                ...
                Keyword = title ?? description ?? Category ?? uploadDate?.ToString("yyyy-MM-dd") ?? "*",
